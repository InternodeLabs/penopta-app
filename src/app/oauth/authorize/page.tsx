...
/**
 * OAuth authorization endpoint (consent screen). Human authentication is
 * delegated to Internode via the existing session; this page only lets the
 * signed-in user approve a connector, after which an authorization code is
 * issued to its redirect URI.
 */
export default async function AuthorizePage({
  ...
  if (params.response_type !== "code") {
    redirect(appendError(redirectUri, "unsupported_response_type", params.state));
  }
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-surface p-8">
        ...
        <div className="mt-6 rounded-xl border border-border bg-background p-4">
          ...
          <ul className="mt-2 space-y-1 text-sm text-muted">
            <li>• Read your projects and their linked conversation threads</li>
