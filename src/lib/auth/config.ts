 ...
 *
 * Penopta does NOT implement its own identity provider. It behaves like the
 * Chrome extension / iOS app / Skillbase: it redirects to the portal, lets the
 * portal's NextAuth session authenticate the user, then exchanges a one-time
 * code for a portal-issued bearer token via a PKCE flow.
 *
...
export const SESSION_COOKIE = "penopta_session";
export const PKCE_VERIFIER_COOKIE = "penopta_pkce_verifier";
export const OAUTH_STATE_COOKIE = "penopta_oauth_state";
export const RETURN_TO_COOKIE = "penopta_return_to";
