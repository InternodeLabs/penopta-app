 ...
 * It does NOT authenticate humans — the actual login is delegated to Internode
 * via the existing session. This layer only mints MCP-scoped resource tokens
 * bound to the portal user id.
 */
